...
public class CustomContactAdapter extends RecyclerView.Adapter<CustomContactAdapter.MyViewHolder> {
    ...
    private ArrayList<ResListitem> arrayList = new ArrayList<>();
    private OnRecyclerClickListener listener;

    public CustomContactAdapter(ArrayList<ResListitem> arrayList, OnRecyclerClickListener listener) {
    ...
    public void onBindViewHolder(MyViewHolder holder, final int position) {
        ...
        ResListitem contact = arrayList.get(position);
